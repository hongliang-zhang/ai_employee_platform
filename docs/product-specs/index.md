...
| [doc-gardening.md](./doc-gardening.md) | Draft | Automated doc gardening via Claude Code in e2b sandbox (2026-04-14) |
...
| [2026-04-15-feishu-gateway-design.md](./2026-04-15-feishu-gateway-design.md) | Active | 飞书（Feishu/Lark）WebSocket 长连接接入设计 (2026-04-15) |
| [2026-04-15-agent-sdk-design.md](./2026-04-15-agent-sdk-design.md) | Active | Agent SDK 设计：`@aaas/agent-sdk` 让开发者一行 `createAgent()` 部署到 AaaS harness (2026-04-15) |
